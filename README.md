# All in One Accessibility®: OroCommerce Bundle
...
- OroCommerce version ^6.0.0

### Steps

1. Run `composer require skynettechnologies/all-in-one-accessibility-bundle`

2. Oro should auto-discover the bundle via Symfony flex/autoload.
   If not, register it in config/bundles.php
    ```
    return [
        // ...
        Skynettechnologies\Bundle\AllInOneAccessibilityBundle\AcmeAllInOneAccessibilityBundle::class => ['all' => true],
    ];

    ```
3. Now let's clean your cache and dump your assets:
    ```
...
To configure the widget, access the Admin Panel and head to the system > **All in One Accessibility** menu in the dashboard. From there, you can register **[here](https://ada.skynettechnologies.us/trial-subscription)** with 10 Days free trial.
